  ...
  return (
    <header className="shrink-0 border-b border-[var(--border)] bg-[var(--background)]/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-4">
        <ClaudeAcademyBrand size="sm" className="min-w-0 shrink" />
        <Link
          href="/#comunidade"
          className="shrink-0 rounded-lg px-3 py-2 text-sm text-[var(--muted)] transition hover:text-[var(--foreground)]"
        >
          <span className="sm:hidden">Comunidade</span>
          <span className="hidden sm:inline">Voltar à comunidade</span>
        </Link>
      </div>
    </header>
  );
